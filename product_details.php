...
<div class="row px-1">
    ...
    <div class="col-md-4">
      ...
      <div class='col-md-4 mb-2'>
            <div class='card' style='width: 18rem;'>
              <img src='./pics/apple.jpg' class='card-img-top' alt="{$row['product_title']}">
              <div class='card-body'>
    ...
    <div class="col-md-8">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
         <img src='./pics/apple2.jpg' class='card-img-top' alt="{$row['product_title']}">
        </div>

        <div class="col-md-6">
         <img src='./pics/apple3.jpg' class='card-img-top' alt="{$row['product_title']}">
        </div>
      </div>
    </div>
      <!-- fetching products -->
